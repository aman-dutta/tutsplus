...
class TutsplusSpider(CrawlSpider):
    ...
    def parse_item(self, response):
        #  //ol[@class="posts category-sidebar-ad-mobile view posts--with-sidebar nolinks view--loaded"]----All the tutorials
        #  //a[@class='posts__post-title ']/h1/text() -- Title of the Tutorials
